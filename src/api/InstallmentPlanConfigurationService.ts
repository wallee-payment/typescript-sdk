...
class InstallmentPlanConfigurationService {
    ...
    */
    public count (spaceId: number, filter: EntityQueryFilter, options: any = {}) : Promise<{ response: http.IncomingMessage; body: number;  }> {
        const localVarPath = '/installment-plan-configuration/count';
    ...
    */
    public read (spaceId: number, id: number, options: any = {}) : Promise<{ response: http.IncomingMessage; body: InstallmentPlanConfiguration;  }> {
        const localVarPath = '/installment-plan-configuration/read';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this.defaultHeaders);
        let localVarFormParams: any = {};
    ...
    */
    public search (spaceId: number, query: EntityQuery, options: any = {}) : Promise<{ response: http.IncomingMessage; body: Array<InstallmentPlanConfiguration>;  }> {
        const localVarPath = '/installment-plan-configuration/search';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this.defaultHeaders);
        let localVarFormParams: any = {};

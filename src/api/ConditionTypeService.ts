...
class ConditionTypeService {
    ...
    */
    public conditionTypeServiceAll (options: any = {}) : Promise<{ response: http.IncomingMessage; body: Array<ConditionType>;  }> {
    ...
    * @param {*} [options] Override http request options.
    */
    public conditionTypeServiceRead (id: number, options: any = {}) : Promise<{ response: http.IncomingMessage; body: ConditionType;  }> {
        ...
        let localVarFormParams: any = {};
            ...
            if (id === null || id === undefined) {
                throw new Error('Required parameter id was null or undefined when calling conditionTypeServiceRead.');
            }

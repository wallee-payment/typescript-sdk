...
class DocumentTemplateTypeService {
    ...
    */
    public documentTemplateTypeServiceAll (options: any = {}) : Promise<{ response: http.IncomingMessage; body: Array<DocumentTemplateType>;  }> {
    ...
    * @param {*} [options] Override http request options.
    */
    public documentTemplateTypeServiceRead (id: number, options: any = {}) : Promise<{ response: http.IncomingMessage; body: DocumentTemplateType;  }> {
        ...
        let localVarFormParams: any = {};
            ...
            if (id === null || id === undefined) {
                throw new Error('Required parameter id was null or undefined when calling documentTemplateTypeServiceRead.');
            }

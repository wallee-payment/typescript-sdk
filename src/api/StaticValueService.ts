...
class StaticValueService {
    ...
    */
    public staticValueServiceAll (options: any = {}) : Promise<{ response: http.IncomingMessage; body: Array<StaticValue>;  }> {
    ...
    * @param {*} [options] Override http request options.
    */
    public staticValueServiceRead (id: number, options: any = {}) : Promise<{ response: http.IncomingMessage; body: StaticValue;  }> {
        ...
        let localVarFormParams: any = {};
            ...
            if (id === null || id === undefined) {
                throw new Error('Required parameter id was null or undefined when calling staticValueServiceRead.');
            }

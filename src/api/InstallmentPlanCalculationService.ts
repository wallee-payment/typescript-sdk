...
class InstallmentPlanCalculationService {
    ...
    */
    public installmentPlanCalculationServiceCalculatePlans (spaceId: number, transactionId: number, options: any = {}) : Promise<{ response: http.IncomingMessage; body: Array<InstallmentCalculatedPlan>;  }> {
        ...
        let localVarFormParams: any = {};
            ...
            if (spaceId === null || spaceId === undefined) {
                throw new Error('Required parameter spaceId was null or undefined when calling installmentPlanCalculationServiceCalculatePlans.');
            }

            // verify required parameter 'transactionId' is not null or undefined
            if (transactionId === null || transactionId === undefined) {
                throw new Error('Required parameter transactionId was null or undefined when calling installmentPlanCalculationServiceCalculatePlans.');
            }

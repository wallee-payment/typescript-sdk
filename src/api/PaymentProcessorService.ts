...
class PaymentProcessorService {
    ...
    */
    public paymentProcessorServiceAll (options: any = {}) : Promise<{ response: http.IncomingMessage; body: Array<PaymentProcessor>;  }> {
    ...
    * @param {*} [options] Override http request options.
    */
    public paymentProcessorServiceRead (id: number, options: any = {}) : Promise<{ response: http.IncomingMessage; body: PaymentProcessor;  }> {
        ...
        let localVarFormParams: any = {};
            ...
            if (id === null || id === undefined) {
                throw new Error('Required parameter id was null or undefined when calling paymentProcessorServiceRead.');
            }

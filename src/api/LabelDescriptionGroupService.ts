...
class LabelDescriptionGroupService {
    ...
    */
    public labelDescriptionGroupServiceAll (options: any = {}) : Promise<{ response: http.IncomingMessage; body: Array<LabelDescriptorGroup>;  }> {
    ...
    * @param {*} [options] Override http request options.
    */
    public labelDescriptionGroupServiceRead (id: number, options: any = {}) : Promise<{ response: http.IncomingMessage; body: LabelDescriptorGroup;  }> {
        ...
        let localVarFormParams: any = {};
            ...
            if (id === null || id === undefined) {
                throw new Error('Required parameter id was null or undefined when calling labelDescriptionGroupServiceRead.');
            }

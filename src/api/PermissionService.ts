...
class PermissionService {
    ...
    */
    public permissionServiceAll (options: any = {}) : Promise<{ response: http.IncomingMessage; body: Array<Permission>;  }> {
    ...
    * @param {*} [options] Override http request options.
    */
    public permissionServiceRead (id: number, options: any = {}) : Promise<{ response: http.IncomingMessage; body: Permission;  }> {
        ...
        let localVarFormParams: any = {};
            ...
            if (id === null || id === undefined) {
                throw new Error('Required parameter id was null or undefined when calling permissionServiceRead.');
            }

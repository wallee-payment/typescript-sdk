...
class PaymentMethodService {
    ...
    */
    public paymentMethodServiceAll (options: any = {}) : Promise<{ response: http.IncomingMessage; body: Array<PaymentMethod>;  }> {
    ...
    * @param {*} [options] Override http request options.
    */
    public paymentMethodServiceRead (id: number, options: any = {}) : Promise<{ response: http.IncomingMessage; body: PaymentMethod;  }> {
        ...
        let localVarFormParams: any = {};
            ...
            if (id === null || id === undefined) {
                throw new Error('Required parameter id was null or undefined when calling paymentMethodServiceRead.');
            }

...
class DebtCollectorService {
    ...
    */
    public debtCollectorServiceAll (options: any = {}) : Promise<{ response: http.IncomingMessage; body: Array<DebtCollector>;  }> {
        const localVarPath = this.basePath + '/debt-collector/all';
        ...
        return new Promise<{ response: http.IncomingMessage; body: Array<DebtCollector>;  }>((resolve, reject) => {
    ...
    * @param {*} [options] Override http request options.
    */
    public debtCollectorServiceRead (id: number, options: any = {}) : Promise<{ response: http.IncomingMessage; body: DebtCollector;  }> {
        const localVarPath = this.basePath + '/debt-collector/read';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this.defaultHeaders);
        let localVarFormParams: any = {};
            ...
            if (id === null || id === undefined) {
                throw new Error('Required parameter id was null or undefined when calling debtCollectorServiceRead.');
            }
        ...
        return new Promise<{ response: http.IncomingMessage; body: DebtCollector;  }>((resolve, reject) => {
            localVarRequest(localVarRequestOptions, (error, response, body) => {
                if (error) {
                    reject(error);
                } else {

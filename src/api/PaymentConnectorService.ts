...
class PaymentConnectorService {
    ...
    */
    public paymentConnectorServiceAll (options: any = {}) : Promise<{ response: http.IncomingMessage; body: Array<PaymentConnector>;  }> {
    ...
    * @param {*} [options] Override http request options.
    */
    public paymentConnectorServiceRead (id: number, options: any = {}) : Promise<{ response: http.IncomingMessage; body: PaymentConnector;  }> {
        ...
        let localVarFormParams: any = {};
            ...
            if (id === null || id === undefined) {
                throw new Error('Required parameter id was null or undefined when calling paymentConnectorServiceRead.');
            }

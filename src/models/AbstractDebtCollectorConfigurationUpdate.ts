 ...
 */
export function instanceOfAbstractDebtCollectorConfigurationUpdate(value: object): value is AbstractDebtCollectorConfigurationUpdate {
    return true;
}

export function AbstractDebtCollectorConfigurationUpdateFromJSON(json: any): AbstractDebtCollectorConfigurationUpdate {
    return AbstractDebtCollectorConfigurationUpdateFromJSONTyped(json, false);
}

export function AbstractDebtCollectorConfigurationUpdateFromJSONTyped(json: any, ignoreDiscriminator: boolean): AbstractDebtCollectorConfigurationUpdate {
    if (json == null) {
        return json;
    }
    return {

...
export function AbstractDebtCollectionCaseUpdateToJSON(json: any): AbstractDebtCollectionCaseUpdate {
    return AbstractDebtCollectionCaseUpdateToJSONTyped(json, false);
}

export function AbstractDebtCollectionCaseUpdateToJSONTyped(value?: AbstractDebtCollectionCaseUpdate | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }

 ...
 */
export function instanceOfDebtCollectionCaseListResponse(value: object): value is DebtCollectionCaseListResponse {
    return true;
}

export function DebtCollectionCaseListResponseFromJSON(json: any): DebtCollectionCaseListResponse {
    return DebtCollectionCaseListResponseFromJSONTyped(json, false);
}

export function DebtCollectionCaseListResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): DebtCollectionCaseListResponse {
    if (json == null) {
        return json;
    }
    return {
...
export function DebtCollectionCaseListResponseToJSON(json: any): DebtCollectionCaseListResponse {
    return DebtCollectionCaseListResponseToJSONTyped(json, false);
}

export function DebtCollectionCaseListResponseToJSONTyped(value?: Omit<DebtCollectionCaseListResponse, 'data'|'hasMore'|'limit'> | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
